...
- A full team meeting will take place every Wednesday evening, 7pm-8pm. Attendance is expected; see the [attendance policy](./attendance.md).
- There are no formal classroom sessions.
- Office hours: see the instructor's [office hour
    webpage](https://johnmaccormick.github.io/jmac-web/office-hours.html).
...
The final grade will be assessed via four equally weighted _marking periods_ (MP1-MP4) and a _cumulative achievement_ score (CA):
...
Grades for the course are based largely on effort. Effort is measured in various ways, but one important indicator is the amount of time dedicated to the project. For this reason we define the _minimum time expectation_ (MTE) for the course as
...
An _activity log_ is a private Microsoft Teams channel in which a student keeps a log of all activity for the course, preferably updated in real time several times per week. A _public activity log post_ is a post in the public channel that summarizes the student's activity for the week. Activity logs are discussed in more detail on the separate [activity log page](activity-logs.md). 

### Deliverables

A _deliverable_ is any output produced by work on the project. Deliverables include but are not limited to:
...
The following thresholds, or possibly more generous thresholds, will be used for final grades:
93%=A; 90%=A−; 87%=B+; 83%=B; ...; 60%=D−.
...
The instructors will follow college policy on [Accommodating Students with Disabilities](http://users.dickinson.edu/~jmac/accommodations.html).
